    ...
    public class Scrapper1XBetSoccer : BetApi
    {
        ...
        public override List<SportEvent> ListEvents()
        {
            ...
            Parallel.ForEach(events?.Value, e =>
            {
                ...
                eventsSportsData.Add(new(e.I.ToString(), e.LI.ToString(), e.CI.ToString(), e.L, DateTime.Now, e.O1, e.O2, new(e.E[0].C, e.E[2].C, e.E[1].C, oddsMore2and5[0].C, oddsMore2and5[1].C), "1XBET", urlHome));
            });
